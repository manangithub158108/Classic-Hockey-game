...
function draw(){
  ...
  if(gameState === 1){
    ...
    textFont('Georgia');
    fill('darkBlue');
    text('! Welcome to the Classic Hockey game !', 12.5, height/2 - 100); 
  }
  ...
  if(gameState === 2){
    ...
    textFont('Ayuthaya');
    fill('darkBlue');
    text(playerScore, 15, height/2 - 10); 

    textSize(30);
    textFont('Ayuthaya');
    fill('darkBlue');
    text(opponentScore, 325, height/2 - 10); 
  ...
  if(gameState === 3){
    ...
    textFont('Georgia');
    fill('darkBlue');
    text('Thanks for playing my dear user !', width/2 - 150, height/2 - 100); 
